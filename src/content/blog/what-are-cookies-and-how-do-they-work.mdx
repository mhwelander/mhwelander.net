...
A cookie is a **piece of text** sent by a website to your browser that **uniquely identifies you** to that website. They have a name (`_cookieName`) and a weird-looking value (`34ADE4DDX8392`):
...
<figCaption>"Hi, I'm your cookie"</figCaption>
 ...
 Your browser **stores that cookie**, and includes it in every subsequent requests to website. The website now has a mechanism by which to identify you between page requests and (depending on whether it is a session cookie or a persistent cookie) between browsing sessions:
...
Without a cookie or other form of identifier, you cannot be identified between page requests or sessions. You are a shiny and exciting stranger each time you request a page.

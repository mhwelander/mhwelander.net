...
A cookie is a **piece of text** sent by a website to your browser that **uniquely identifies you** to that website:
...
<Block class="warning">
This might present a problem if you legally obligated to document all cookies and provide a way for vistors to opt in and out of processing (for example, by declining tracking cookies).
</Block>

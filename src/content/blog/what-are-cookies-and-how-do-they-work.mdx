...
If a cookie that comes from a different website (has a different domain) than the one you are currently visiting, it is called a **[third party or 'cross-site' cookie](#third-party-cookies)**.
...
For example - are you fingerprinting someone by generating a hash of their IP address and user agent, _without_ a sprinkle of some kind of time-limited salt? Smells like a cookie in a Halloween costume to me.

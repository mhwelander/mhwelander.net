...
<Block class="note">
This blog post is about how cookies work - specifically _cookies_, and specifically how they _work_. It is not legal advice, nor does it cover other means of tracking and identifying users online.
</Block>
...
<figCaption>"Hi, I'm your cookie"</figCaption>
 ...
 Your browser **stores that cookie**, and includes it in every subsequent requests to website. The website now has a mechanism by which to identify you between page requests and (depending on the type of cookie) between browsing sessions:

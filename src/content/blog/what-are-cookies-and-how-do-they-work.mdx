...
<figure class= "centerFig">
<div  data-lightbox="true">
![A screenshot of Google Chrome Dev Tools, showing the Network tab with event.js selected. In the right-hand panel, you can see that a Set-Cookie hader sets the _ttp cookie.](./images/2024/using-the-cookie-1.png)
</div>
...
<figure class="centerFig w300">
![A black-and-white digital drawing of a third-party tcookie character with arms and legs. It is wearing a sash with a domain name, a cookie name, and a random string of numbers and letters. It is also wearing a black mask over its eyes.](./images/2024/third-party-cookie.png)
...
**Cookie-less tracking** offers an alternative - but you can't track visitors between websites, _or even between sessions_. Doing so would require an **identifier** that persists (or can be reliably re-created) across sessions. Are you fingerprinting someone by generating a hash of their IP address and user agent? The same, repeatable inputs every time? Smells like a cookie in a Halloween costume to me.

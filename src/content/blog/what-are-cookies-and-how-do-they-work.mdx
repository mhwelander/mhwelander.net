...
The EU [ePrivacy Directive](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A02002L0058-20091219) has been around since 2002 and explicitly mentions that you need consent to store a cookie (or anything cookie-_like_):
 
 > Users should have the opportunity to refuse to have a cookie or similar device stored on their terminal equipment. 
 
[GDPR](https://www.edps.europa.eu/data-protection/data-protection/legislation/history-general-data-protection-regulation_en) has applied in the European Union since 2018, and refers to [online identifiers](https://gdpr-info.eu/recitals/no-30/) (like cookies) throughout.
...
The ✨**general vibe**✨ of privacy legislation (at least in the EU) centers on **active consent** and **the right to be informed**. I actually started writing this blog post because I wanted to understand _exactly_ why Google Analytics requires consent, and it turns out to be quite simple:
 ...
 > Google Analytics issues a **(first-party) cookie**, which is an online identifier that [links a natural person to a device](https://gdpr-info.eu/recitals/no-30/). That makes it [personal data](https://gdpr-info.eu/issues/personal-data/).

And that requires consent from Europeans - ergo, cookie popup required for my tiny blog.

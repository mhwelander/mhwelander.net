...
<figCaption>"Hi, I'm your cookie"</figCaption>
 ...
 Your browser **stores that cookie**, and includes it in subsequent requests to that website [for as long as that cookie lasts](#how-long-does-a-cookie-last). This means that the website has a **mechanism** by which to identify you between page requests and (depending on the type of cookie) between browsing sessions:
...
Without a cookie (or some other online identifier), a website cannot identify you between requests. You are a shiny and exciting stranger each time you request a page - like the internet of old (really, really old).

### What is a cookie used for?

Cookies by themselves don't really do anything; they are passed back and forth between the browser and the website in a not-so-thrilling game of virtual table tennis. However, when a website can uniquely identify you, it :

* Which country you visited from
* Which pages you visited and in which order
* How long you spent on each page
* How far you scrolled
* Which components you interacted with (clicked on, hovered over)

[IMAGE NEEDED - interconnected pieces of information]

[IMAGE NEEDED - disconnected pieces of information]

#### Example: Analytics

* Notice that x people visit a blog post about domestic birds
...
[IMAGE NEEDED - iframes and scripts issuing cookies]

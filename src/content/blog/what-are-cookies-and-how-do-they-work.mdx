...
For example, [TikTok](https://ads.tiktok.com/help/article/tiktok-pixel) and [Snapchat](https://businesshelp.snapchat.com/s/topic/0TO0y000000YVdJGAW/snap-pixel?language=en_US) use a **single pixel** to set third-party cookies. This cookie is then accessed by their tracking script - on your website, and **on any website you visit that has the tracking script**.
...
The thing that makes them third-party cookies is this: <span class="highlight">**the cookie domain does not match the current site.**</span>

That's it. It is the **context in which a cookie appears** that makes it third-party or first-party; the cookie itself is not inherently third or first party.

### Who is summonining these cookies?

I visited ███████.com, accepted all cookies, and looked in the Application tab - _most_ of the cookies are third party:
...
I have never visited doubleclick.net.

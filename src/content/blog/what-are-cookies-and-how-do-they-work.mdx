...
A cookie is a way to **uniquely identify** a person **between page requests** (going from one page to another) and **between sessions** (visiting a site on Monday, and then on Friday). Here is how the internet works without cookies (if we assume that [cookies are the only way to uniquely identify a person](#)):
